...
def processos_no_setor(request):
    ...
    receber_paginator = Paginator(receber,10)
    page_num_receber = request.GET.get('page_receber')
    ...
    recebidos_paginator = Paginator(recebidos,10)
    page_num_recebidos = request.GET.get('page_recebidos')
